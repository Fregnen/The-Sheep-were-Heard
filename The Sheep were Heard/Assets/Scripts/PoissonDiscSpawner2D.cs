...
///   PoissonDiscSpawner2D sampler = new PoissonDiscSpawner2D(10, 5, 0.3f);
///   foreach (Vector2 sample in sampler.Samples()) {
///       Instantiate(someObject, new Vector3(sample.x, 0, sample.y), Quaternion.identity);
///   }

public class PoissonDiscSpawner2D
{
    ...
    public PoissonDiscSpawner2D(float width, float height, float radius)
    {
